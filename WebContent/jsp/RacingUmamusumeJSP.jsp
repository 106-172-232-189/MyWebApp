	...
	<body>
		...
		<div>
			...
			<form action="RacingUmamusumeList" method="post">
				<input type="text" name="id" value="<%= id == null ? "" : id %>" placeholder="勝負服番号もしくは名前" pattern="(^[0-9０-９]{1,3}$)|(^[^\x01-\x7E]{0,30}$)">
				<button type="submit">検索</button>
			</form>
			<br>
			<table>
				<tr>
					<th colspan="2">勝負服</th><th>名前<br><div class="div3">&amp;勝負服登録日</div></th>
				</tr>
			...
			&nbsp;&nbsp;&nbsp;&nbsp;特殊なウマ娘に勝負服番号を割り当てる際に参考にしたページ: <br class="br-sp"><a href="https://www.tento.camp/tenwa/column/2016/10/31/647/">https://www.tento.camp/tenwa/column/2016/<br class="br-sp2">10/31/647/</a><br>
			]<br>
			</div>
