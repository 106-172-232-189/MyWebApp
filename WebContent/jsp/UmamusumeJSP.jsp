	...
	<body>
		...
		<div>
			...
			<form action="UmamusumeList" method="post">
				<input type="radio" name="mode" value="true" <%= mode ? "checked" : "" %>>図鑑番号<br>
				<input type="radio" name="mode" value="false" <%= mode ? "" : "checked" %>>勝負服番号<br>
				<input type="text" name="id" value="<%= id == null ? "" : id %>" placeholder="番号もしくは名前" pattern="(^[0-9０-９]{1,3}$)|(^[^\x01-\x7E]{0,30}$)">
			...
			※: 図鑑番号は800番台、900番台を除いて公式です。<br>
			※※: 勝負服番号は800番台、900番台を除いて公式です。<br>
			出典: [<br>
			...
			&nbsp;&nbsp;&nbsp;&nbsp;特殊なウマ娘に図鑑番号や勝負服番号を割り当てる際に参考にしたページ: <br class="br-sp"><a href="https://www.tento.camp/tenwa/column/2016/10/31/647/">https://www.tento.camp/tenwa/column/2016/<br class="br-sp2">10/31/647/</a><br>
			]<br>
			</div>
			<p><a href="https://twitter.com/RbSbH9WTaKkBtGd">管理者のTwitterアカウント</a></p>
